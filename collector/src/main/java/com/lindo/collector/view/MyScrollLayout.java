...
import com.lindo.collector.ui.GuideActivity;
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (newX - oldx > 3) {
				...
				if (currentPage == pagesize - 1 && !go_main) {
					...
					map.put("isOpen", true);
					Utils.saveMsg(mContext, Constant.APP_FILE_NAME, map);
					...
					intent.setClass(mContext, MainUIActivity.class);
