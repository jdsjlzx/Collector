package com.lindo.collector.umeng.fb;
...
public class UmengCustomFBActivity extends BaseActivity {
	...
	private final String TAG = UmengCustomFBActivity.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_umeng_fb_custom);
		mContext = this;
